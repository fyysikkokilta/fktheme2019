<?php
/**
 * FK2018 functions and definitions
 *
 * @package understrap
 */
...
$fk_includes = array(						// Separating this from understrap only to make this more readable
	...
	'/fk-functions.php',					// Hide stuff from admin menu
);
